const elements2 = [
  ...
  },
  {
    ...
    "name": "Helium",
    "symbol": "He",
    "discoverer": "Pierre Jules César Janssen | Sir Joseph Norman Lockyer",
    "discovery_year": 1868,
    "appearance": "A colourless, odourless gas that is totally unreactive.",
    "place": "After hydrogen, helium is the second most abundant element in the universe. It is present in all stars. It was, and is still being, formed from alpha-particle decay of radioactive elements in the Earth.",
    ...
    "dangers": "Danger of Asphyxiation",
    "name_origin": "The name is derived from the Greek, 'helios' meaning sun, as it was in the sun's corona that helium was first detected.",
  ...
  },
  {
    ...
    "place": "Most lithium is currently produced in Chile, from brines that yield lithium carbonate when treated with sodium carbonate.",
    ...
    "dangers": "Lithium can poison a developing baby (fetus) and can increase the risk of birth defects, including heart problems.Heart disease,Kidney disease.here is some concern that lithium might interfere with surgical procedures that often involve anesthesia and other drugs that affect the central nervous system.",
  ...
  },
  {
    ...
    "place": "Beryllium is found in about 30 different mineral species. The most important are beryl (beryllium aluminium silicate) and bertrandite (beryllium silicate).",
    ...
    "dangers": "According to NIOSH (the National Institute for Occupational Safety and Health, 2011), \"workers exposed to particles, fumes, mists and solutions from beryllium-containing materials may develop beryllium sensitization or chronic beryllium disease, a potentially disabling or even fatal respiratory disease.",
    "name_origin": "The name is derived from the Greek name for beryl, 'beryllo'.",
  ...
  },
  {
    ...
    "discovery_year": "30 June 1808",
    "appearance": "Pure boron is a dark amorphous powder.",
    "place": "Boron occurs as an orthoboric acid in some volcanic spring waters, and as borates in the minerals borax and colemanite. Extensive borax deposits are found in Turkey. However, by far the most important source of boron is rasorite. This is found in the Mojave Desert in California, USA.",
    ...
    "name_origin": "The name is derived from the Arabic 'buraq', which was the name for borax.",
  ...
  },
  {
    ...
    "place": "carbon is found in all living things. It is also found in fossilised remains in the form of hydrocarbons (natural gas, crude oil, oil shales, coal etc) and carbonates (chalk, limestone, dolomite etc).",
    "uses": "hydrocarbons are extracted naturally as fossil fuels (coal, oil and natural gas),  mostly used as fuels. A small but important fraction is used as a feedstock for the petrochemical industries producing polymers, fibres, paints, solvents and plastics etc.\n\nImpure carbon in the form of charcoal (from wood) and coke (from coal) is used in metal smelting. It is particularly important in the iron and steel industries.\n\nGraphite is used in pencils, to make brushes in electric motors and in furnace linings. Activated charcoal is used for purification and filtration. It is found in respirators and kitchen extractor hoods.\n\nCarbon fibre is finding many uses as a very strong, yet lightweight, material. It is currently used in tennis rackets, skis, fishing rods, rockets and aeroplanes.\n\nAtmospheric carbon dioxide allows visible light in but prevents some infrared escaping (the natural greenhouse effect). This keeps the Earth warm enough to sustain life.",
    "dangers": "",
  ...
  },
  {
    ...
    "discovery_year": 1772,
    "appearance": "A colourless, odourless gas.",
    "place": "Oxygen makes up 21% of the atmosphere by volume.  The element and its compounds make up 49.2% by mass of the Earth’s crust, and about two-thirds of the human body.",
    ...
    "dangers": "Oxygen enrichment of the atmosphere, even by a few percent, considerably increases the risk of fire. In oxygen-enriched atmospheres, or where oxygen enrichment can occur, smoking must be strictly forbidden.Pulmonary Oxygen Toxicity",
    "name_origin": "The name comes from the Greek 'oxy genes', meaning acid forming.",
  ...
  },
  {
    ...
    "place": "The most common fluorine minerals are fluorite, fluorspar and cryolite, but it is also rather widely distributed in other minerals. It is the 13th most common element in the Earth’s crust.\n\nFluorine is made by the electrolysis of a solution of potassium hydrogendifluoride (KHF2) in anhydrous hydrofluoric acid.",
  ...
  },
  {
    ...
    "dangers": "Effects of exposure: Inhalation: Simple asphyxiant. Skin: On contact with liquid: frostbite. Eyes: On contact with liquid: frostbite.",
  ...
  },
  {
    ...
    "place": "Sodium is the sixth most common element on Earth, and makes up 2.6% of the Earth’s crust. The most common compound is sodium chloride. This very soluble salt has been leached into the oceans over the lifetime of the planet, but many salt beds or ‘lakes’ are found where ancient seas have evaporated. It is also found in many minerals including cryolite, zeolite and sodalite.",
  ...
  },
  {
    ...
    "place": "Magnesium is the eighth most abundant element in the Earth’s crust, but does not occur uncombined in nature. It is found in large deposits in minerals such as magnesite and dolomite. The sea contains trillions of tonnes of magnesium.",
    ...
    "dangers": "Hypermagnesemia is rare because the kidneys work to get rid of excess magnesium. Overdose is most often seen in people with kidney failure after they take medications containing magnesium, such as laxatives or antacids.\n\nIt’s because of this risk that people with kidney disease are cautioned against taking magnesium supplements or medications that contain this mineral. The risks are also higher for people with heart disease and gastrointestinal disorders.",
    "name_origin": "The name is derived from Magnesia, a district of Eastern Thessaly in Greece.",
  ...
  },
  {
    ...
    "place": "Aluminium is the most abundant metal in the Earth’s crust (8.1%) but is rarely found uncombined in nature. It is usually found in minerals such as bauxite and cryolite. These minerals are aluminium silicates.",
    ...
    "dangers": "Aluminum: Bad for Your Brain it can cause Alzheimer's Disease",
    "name_origin": "The name is derived from the Latin name for alum, 'alumen' meaning bitter salt.",
  ...
  },
  {
    ...
    "place": "Silicon makes up 27.7% of the Earth's crust by mass and is the second most abundant element (oxygen is the first). It does not occur uncombined in nature but occurs chiefly as the oxide (silica) and as silicates.",
    ...
    "dangers": "Silicon may cause chronic respiratory effects.",
    "name_origin": "The name is derived from the Latin 'silex' or 'silicis', meaning flint.",
  ...
  },
  {
    ...
    "place": "Phosphorus is not found uncombined in nature, but is widely found in compounds in minerals. An important source is phosphate rock, which contains the apatite minerals and is found in large quantities in the USA and elsewhere.",
    ...
    "dangers": "Can cause such as kidney damage and osteoporosis.",
    "name_origin": "The name is derived from the Greek 'phosphoros', meaning bringer of light.",
  ...
  },
  {
    ...
    "name": "Sulfur",
    "symbol": "S",
    "discoverer": "Antoine-Laurent de Lavoisier",
    "discovery_year": 1777,
    "appearance": "There are several allotropes of sulfur. The most common appears as yellow crystals or powder.",
    "place": "Sulfur occurs naturally as the element, often in volcanic areas. This has traditionally been a major source for human use. It is also widely found in many minerals including iron pyrites, galena, gypsum and Epsom salts.",
  ...
  },
  {
    ...
    "place": "Chlorine is not found uncombined in nature. Halite (sodium chloride or ‘common salt’) is the main mineral that is mined for chlorine. Chlorine is also found in the minerals carnallite (magnesium potassium chloride) and sylvite (potassium chloride).",
    ...
    "dangers": "Direct contact with skin is much less common given that chlorine is a gas at room temperature. Gas exposure can cause skin and eye irritation at low levels and severe chemical burns at high levels. Skin contact with liquid chlorine can cause frostbite.",
    "name_origin": "The name is derived from the Greek 'chloros', meaning greenish yellow.",
  ...
  },
  {
    ...
    "name": "Argon",
    "symbol": "Ar",
    "discoverer": "John William Strutt, 3rd Baron Rayleigh\n | William Ramsay",
    "discovery_year": 1894,
    "appearance": "Argon is a colourless, odourless gas that is totally inert to other substances.",
    "place": "Argon makes up 0.94% of the Earth’s atmosphere and is the third most abundant atmospheric gas.Argon is obtained commercially by the distillation of liquid air.",
    ...
    "dangers": "Environmental Effects\nArgon will dissipate into the air under normal environmental conditions. It is not harmful to plant and animal life. Argon does not cause adverse effects to an aquatic environment.Skin or Eye Contact\nIf compressed argon is rapidly released from a tank directly into the eyes or onto the skin, it may cause frostbite, injury or damage by freezing, which can progress from initial redness and tingling to gangrene if not treated.\n\nFire Hazard\nTanks of argon may explode in the heat of a fire due to increased pressure within the tank.Inhalation\nInhalation of a small amount of argon is not expected to cause adverse health effects. But, should there be an oxygen-deficient environment caused by release of a large quantity of argon, especially in a confined space, a person may experience symptoms such as headache, ringing in the ears, dizziness, drowsiness, unconsciousness, nausea, vomiting and depression of all the senses. Being confined to an oxygen-deficient environment for a prolonged period of time can even prove fatal.",
    "name_origin": "The name is derived from the Greek, 'argos', meaning idle.",
  ...
  },
  {
    ...
    "place": "Potassium is the seventh most abundant metal in the Earth’s crust. It makes up 2.4% by mass. There are deposits of billions of tonnes of potassium chloride throughout the world. Mining extracts about 35 million tonnes a year.\n\nMost potassium minerals are found in igneous rocks and are sparingly soluble.",
    ...
    "dangers": "Can cause hyperkalemia",
    "name_origin": "The name is derived from the English word 'potash'.",
  ...
  },
  {
    ...
    "place": "Calcium is the fifth most abundant metal in the Earth’s crust (4.1%). It is not found uncombined in nature, but occurs abundantly as limestone (calcium carbonate), gypsum (calcium sulfate), fluorite (calcium fluoride) and apatite (calcium chloro- or fluoro-phosphate).",
    "uses": "Calcium metal is used as a reducing agent in preparing other metals such as thorium and uranium. It is also used as an alloying agent for aluminium, beryllium, copper, lead and magnesium alloys.\n\nCalcium compounds are widely used. There are vast deposits of limestone (calcium carbonate) used directly as a building stone and indirectly for cement.  It is also used in steel making to remove impurities from the molten iron ore. \n\nGypsum (calcium sulfate) is used by builders as a plaster and by nurses for setting bones, as ‘plaster of Paris’.",
    "dangers": "A lack of calcium is one of the main causes of osteoporosis.",
    "name_origin": "The name is derived from the Latin 'calx' meaning lime.",
  ...
  },
  {
    ...
    "place": "Scandium is very widely distributed, and occurs in minute quantities in over 800 mineral species. It is the main component of the very rare and collectable mineral thortveitite, found in Scandinavia.",
  ...
  },
  {
    ...
    "place": "Titanium is the ninth most abundant element on Earth. It is almost always present in igneous rocks and the sediments derived from them. It occurs in the minerals ilmenite, rutile and sphene and is present in titanates and many iron ores.",
    ...
    "dangers": "Effects of overexposure to titanium powder: Dust inhalation may cause tightness and pain in chest, coughing, and difficulty in breathing. Contact with skin or eyes may cause irritation. Routes of entry: Inhalation, skin contact, eye contact.\n\nLow toxicity. When in a metallic powdered form, titanium metal poses a significant fire hazard and, when heated in air, an explosion hazard.",
    "name_origin": "The name is derived from the Titans, the sons of the Earth goddess of Greek mythology.",
  ...
  },
  {
    ...
    "place": "Vanadium is found in about 65 different minerals including vanadinite, carnotite and patronite. It is also found in phosphate rock, certain iron ores and some crude oils in the form of organic complexes.",
  ...
  },
  {
    ...
    "place": "Chromium is found mainly in chromite. This ore is found in many places including South Africa, India, Kazakhstan and Turkey. Chromium metal is usually produced by reducing chromite with carbon in an electric-arc furnace, or reducing chromium(III) oxide with aluminium or silicon.",
  ...
  },
  {
    ...
    "name": "Manganese",
    "symbol": "Mn",
    "discoverer": "Johan Gottlieb Gahn | Ignatius Gottfried Kaim | Carl Wilhelm Scheele",
    "discovery_year": 1774,
    "appearance": "A hard, brittle, silvery metal.",
    "place": "Manganese is the fifth most abundant metal in the Earth’s crust.The main mining areas for manganese are in China, Africa, Australia and Gabon. The metal is obtained by reducing the oxide with sodium, magnesium or aluminium, or by the electrolysis of manganese sulfate.",
  ...
  },
  {
    ...
    "place": "Iron is the fourth most abundant element, by mass, in the Earth’s crust. The core of the Earth is thought to be largely composed of iron with nickel and sulfur.\n\nThe most common iron-containing ore is haematite, but iron is found widely distributed in other minerals such as magnetite and taconite.",
    ...
    "dangers": "Iron may cause conjunctivitis, choroiditis, and retinitis if it contacts and remains in the tissues. Iron (III)-O-arsenite, pentahydrate may be hazardous to the environment; special attention should be given to plants, air and water. It is strongly advised not to let the chemical enter into the environment because it persists in the environment.",
    "name_origin": "The name comes from the Anglo-Saxon name 'iren'.",
  ...
  },
  {
    ...
    "place": "Cobalt is found in the minerals cobaltite, skutterudite and erythrite. Important ore deposits are found in DR Congo, Canada, Australia, Zambia and Brazil. Most cobalt is formed as a by-product of nickel refining.",
    ...
    "dangers": "Health effects that are a result of the uptake of high concentrations of cobalt are:\n\n- Vomiting and nausea\n- Vision problems\n- Heart problems\n- Thyroid damage",
    "name_origin": "The name is derived from the German word 'kobald', meaning goblin.",
  ...
  },
  {
    ...
    "place": "A substantial amount of the nickel on Earth arrived with meteorites. One of these landed in the region near Ontario, Canada, hundreds of millions of years ago. This region is now responsible for about 15% of the world’s production.",
    ...
    "dangers": "An uptake of too large quantities of nickel has the following consequences:\n- Higher chances of development of lung cancer, nose cancer, larynx cancer and prostate cancer\n- Sickness and dizziness after exposure to nickel gas\n- Lung embolism\n- Respiratory failure\n- Birth defects\n- Asthma and chronic bronchitis\n- Allergic reactions such as skin rashes, mainly from jewelry\n- Heart disorders\n\nThis can cause various kinds of cancer on different sites within the bodies of animals, mainly of those that live near refineries.",
    "name_origin": "The name is the shortened for of the German 'kupfernickel' meaning either devil's copper or St. Nicholas's copper.",
  ...
  },
  {
    ...
    "symbol": "Cu",
    "discoverer": "Unknown",
    "discovery_year": "9000 BC",
    "appearance": "A reddish-gold metal that is easily worked and drawn into wires.",
    "place": "Copper metal does occur naturally, but by far the greatest source is in minerals such as chalcopyrite and bornite. Copper is obtained from these ores and minerals by smelting, leaching and electrolysis. The major copper-producing countries are Chile, Peru and China.",
    ...
    "dangers": "Long-term exposure to copper can cause irritation of the nose, mouth and eyes and it causes headaches, stomachaches, dizziness, vomiting and diarrhea. Intentionally high uptakes of copper may cause liver and kidney damage and even death. Whether copper is carcinogenic has not been determined yet.\n\nCopper can interrupt the activity in soils, as it negatively influences the activity of microorganisms and earthworms. The decomposition of organic matter may seriously slow down because of this.",
    "name_origin": "The name is derived from the Old English name 'coper' in turn derived from the Latin 'Cyprium aes', meaning a metal from Cyprus",
  ...
  },
  {
    ...
    "place": "Zinc is found in several ores, the principal ones being zinc blende (zinc sulfide) and calamine (zinc silicate). The principal mining areas are in China, Australia and Peru.",
    ...
    "dangers": "Zinc-shortages can even cause birth defects.Zinc cannot only be a threat to cattle, but also to plant species. Plants often have a zinc uptake that their systems cannot handle, due to the accumulation of zinc in soils.\n\nOn zinc-rich soils only a limited number of plants has a chance of survival. \n\nFinally, zinc can interrupt the activity in soils, as it negatively influences the activity of microrganisms and earthworms. The breakdown of organic matter may seriously slow down because of this.",
    "name_origin": "The name is derived from the German, 'zinc', which may in turn be derived from the Persian word 'sing', meaning stone.",
  ...
  },
  {
    ...
    "name": "Gallium",
    "symbol": "Ga",
    "discoverer": "Paul E. Lecoq de Boisbaudran",
    "discovery_year": 1875,
    "appearance": "Gallium is a silvery, glass-like, soft metal.",
    "place": "Gallium does not exist free in nature and there are no minerals with any substantial gallium content. Commercially, most gallium is extracted as a byproduct of aluminum and zinc production. Gallium is also extracted from the flue dusts of coal.",
    "uses": "Can be used in some medical thermometers as non-toxic subtitutes for mercury. | Can be used in semiconductor production mainly for laser diodes, light-emitting diods, solar panels. | It is also used to create brilliant mirrors.",
    "dangers": "Considered to be non-toxic.",
    "name_origin": "The name is derived from the Latin name for France, 'Gallia'",
  ...
  },
  {
    ...
    "discovery_year": 1886,
    "appearance": "Germanium is a lustrous, hard, gray-white semi-metallic element with a crystalline and brittle structure.",
    "place": "The main ore of germanium is germanite, which is about 7% germanium. Commercially, germanium is obtained as a byproduct of metal refining and from some coal ashes.",
    "uses": "The most common use of germanium is as a semiconductor. | Germanium is used in transistors and in integrated circuits. | It is used as an alloying agent and as a catalyst. | It is also used in infrared spectroscopes and infrared detectors. | Some germanium compounds are useful because they are toxic to bacteria but are harmless for mammals.",
    "dangers": "Germanium is not known to be toxic.",
    "name_origin": "The name is derived from the Latin name for Germany, 'Germania'.",
  ...
  },
  {
    ...
    "discovery_year": 1817,
    "appearance": "Selenium exists in several allotropic forms. The most stable form, crystalline hexagonal selenium, is metallic gray. Crystalline monoclinic selenium is a deep red color. Amorphous selenium is red in powder form and is black in vitreous form.",
    "place": "Selenium occasionally occurs free in nature, but more often occurs as selenides of iron, lead, silver, or copper. Commercially, selenium is obtained mainly from anode mud waste produced in the electrolytic refining of copper. Brazil nuts are the richest known dietary source of selenium.",
    "uses": "Selenium is used in the glass industry to decolorize glass and to make red-colored glasses and enamels. | \nIt is used as a catalyst in many chemical reactions. | Selenium is used in solar cells and photocells – in fact the first solar cell was made using selenium. It is also used as a photographic toner. | \nSelenium is used with bismuth in brasses and as an additive to stainless steel. When selenium is added to iron and copper based metals it improves their machinability. | \nSelenium sulfide is used in anti-dandruff shampoos. | Selenium is also an essential trace element for humans and other animals.",
    "dangers": "Elemental selenium’s oral LD50 (the single dose needed to kill 50% of those exposed) is 6700 mg kg-1 in rats; this is similar to ethanol, which is 7000 mg kg-1. These levels are classed as non-toxic. | \nSelenium’s legal airborne permissible exposure limit (PEL) is 0.2 mg m-3 averaged over an 8-hour shift. The EPA describes selenium as not classifiable for human carcinogenicity. Selenium sulfide is a probable carcinogen. | \nMany of selenium’s compounds, such as selenates and selenites, are highly toxic. | \nHydrogen selenide gas (SeH2) is selenium’s most acutely toxic compound.",
    "name_origin": "The name is derived from 'selene', the Greek name for the Moon.",
  ...
  },
  {
    ...
    "discovery_year": 1826,
    "appearance": "Bromine is the only nonmetallic element that is liquid at ordinary temperatures.It is a dense, reddish-brown liquid which evaporates easily at room temperature to a red vapor with a strong, chlorine-like odor.",
    "place": "Bromine is obtained from natural brine deposits. Some bromine is still extracted today from seawater, which contains only about 70 ppm.",
    "uses": "Bromine compounds are used as pesticides, dyestuffs, water purification compounds, and as a flame-retardants in plastics.",
    "dangers": "Bromine is poisonous and causes skin burns.",
    "name_origin": "The name comes from the Greek 'bromos' meaning stench.",
  ...
  },
  {
    ...
    "discoverer": "William Ramsay | Morris Travers",
    "discovery_year": 1898,
    "appearance": "Krypton is a colorless, odorless, inert gas.",
    "place": "Krypton is obtained commercially by fractional distillation of liquid air.",
    "uses": "Krypton is used in lighting products",
    "dangers": "Krypton is considered to be non-toxic.",
    "name_origin": "The name is derived from the Greek 'kryptos', meaning hidden.",
  ...
  },
  {
    ...
    "discovery_year": 1861,
    "appearance": "Rubidium is a soft, silvery-white metallic element. It is solid at room temperature but melts easily, at 39.3 oC.",
    "place": "The main ore of rubidium is lepidolite which contains 1.5% rubidium. Rubidium is usually obtained as a by product of lithium production. Rubidium metal can also be produced by reducing rubidium chloride with calcium.",
    "uses": "Rubidium is used in photocells, as a getter (remover of trace gases) in vacuum tubes and as working fluid in vapor turbines. | \nRubidium-87 is slightly radioactive and has been used extensively in dating rocks. | \nRubidium compounds give a purple color in fireworks. | \nRubidium salts are used in glasses and ceramics.",
    "dangers": "Rubidium is not known to be toxic.",
    "name_origin": "The name is derived form the Latin 'rubidius', meaning deepest red.",
  ...
  },
  {
    ...
    "name": "Strontium",
    "symbol": "Sr",
    "discoverer": "Adair Crawford | William Cruickshank",
    "discovery_year": 1790,
    "appearance": "Strontium is a soft, silvery metal.When cut it quickly turns a yellowish color due to the formation of strontium oxide (strontia, SrO).",
    "place": "Strontium is never found free in nature. The principal strontium ores are celestine (strontium sulfate, SrSO4) and strontianite (strontium carbonate, SrCO3). The main commercial process for strontium metal production is reduction of strontium oxide with aluminum.",
    "uses": "Strontium is used for producing glass (cathode ray tubes) for color televisions. It is also used in producing ferrite ceramic magnets and in refining zinc. | \nThe world’s most accurate atomic clock, accurate to one second in 200 million years, has been developed using strontium atoms. | \nStrontium salts are used in flares and fireworks for a crimson color. | \nStrontium chloride is used in toothpaste for sensitive teeth. | \nStrontium oxide is used to improve the quality of pottery glazes. | \nThe isotope 90Sr is one of the best long-lived, high-energy beta emitters known. It is used in cancer therapy.",
    "dangers": "Strontium’s non-radioactive isotopes are considered non-toxic.",
    "name_origin": "Strontium is named after Strontian, a small town in Scotland.",
  ...
  },
  {
    ...
    "discovery_year": 1789,
    "appearance": "Zirconium is a strong, malleable, ductile, lustrous, grayish-white metal.",
    "place": "Its chief mineral is zircon (zirconium silicate, ZrSiO4). It is produced commercially by reduction of the chloride with magnesium in the Kroll process.",
    "uses": "Zirconium is very poor at absorbing neutrons. It is therefore useful in nuclear energy applications such as in the cladding (outer layer) of fuel rods through which it is important that neutrons can travel easily. | Zirconium is used as to make surgical instruments and is used in steel alloys as a hardening agent. | As a result of its exceptional corrosion resistance, zirconium is used extensively in the chemical industry in corrosive environments where zirconium’s alloys can be found in pipes, fittings and heat exchangers. | Zirconium is also used to make superconductive magnets. | Zirconium based catalysts are used in amination, hydrogenation, isomerization and oxidation reactions.",
    "dangers": "Zirconium is considered to be non-toxic.",
    "name_origin": "The name is derived form the Arabic, 'zargun', meaning gold coloured.",
  ...
  },
  {
    ...
    "discovery_year": 1801,
    "appearance": "Niobium is a shiny, white, ductile metal. In air an oxide layer forms whose color depends on its thickness. Shades of blue, green and yellow are typical.",
    "place": "Niobium is not found free in nature but in minerals such as columbite and tantalite. Minerals that contain niobium often also contain tantalum. Commercially, niobium is extracted by first forming the oxide (Nb2O5). The oxide is then reduced using carbon or hydrogen.",
    "uses": "Niobium is used with iron and other elements in stainless steel alloys and also in alloys with a variety of nonferrous metals, such as zirconium,  | \nNiobium alloys are strong and are often used in pipeline construction. | \nThe metal is used in superalloys for jet engines and heat resistant equipment. | \nNiobium is also used for jewelry. At cryogenic temperatures, niobium is a superconductor.",
    "dangers": "Some niobium compounds are highly toxic.",
    "name_origin": "The name comes from Niobe from Greek mythology, who was the daughter of king Tantalus. This was chosen because of niobium's chemical similarity to tantalum",
  ...
  },
  {
    ...
    "discovery_year": 1937,
    "appearance": "Technetium is a rare, silver-gray metal that tarnishes slowly in moist air.",
    "place": "Technetium has been found naturally occurring in tiny quantities in uranium ore. The isotope technetium-99 is produced from the waste products of uranium nuclear fuel. Technetium-99m is produced by neutron activation of molybdenum-98 to form molybdenum-99, which has a half-life of 65.94 hours and beta-decays to technetium-99m. The spectral signature of technetium has been detected in light from red giant stars.",
    "uses": "Is used as a radioactive tracers | It is used as for equipment calibration. | It can protect carbon steels and iron from corrosion.",
    "dangers": "Technetium is harmful due to its radioactivity.",
    "name_origin": "The name is derived from the Greek 'tekhnetos' meaning artificial.",
  ...
  },
  {
    ...
    "discovery_year": 1844,
    "appearance": "Ruthenium is a very rare, hard, lustrous, brittle, silvery-white metal that does not tarnish at room temperature.",
    "place": "Ruthenium is found free in nature often with the other platinum group metals. Commercially, it is obtained from pentlandite (a sulfide of iron and nickel) which contains small quantities of ruthenium. | \nRuthenium can also be extracted from spent nuclear fuel, however if obtained this way it will contain radioactive isotopes. It has to be stored safely for at least ten years until the radioactive isotopes have decayed.",
    "uses": "Small amounts of ruthenium are used to harden platinum and palladium and it can also be alloyed with these metals to make electrical contacts for severe wear resistance.",
    "dangers": "Ruthenium is a suspected carcinogen and its compounds strongly stain the skin. Ruthenium tetroxide (RuO4) is highly toxic",
    "name_origin": "The name is derived from 'Ruthenia', the Latin name for Russia",
  ...
  },
  {
    ...
    "discovery_year": 1803,
    "appearance": "Rhodium is a rare, hard, silvery-white, lustrous metal.",
    "place": "Rhodium occurs in small quantities in ores metals such as platinum, palladium, nickel, silver, and gold. Commercially, it is obtained as a byproduct of refining nickel sulfide ores from Canada.",
    "uses": "The majority of rhodium is used as a catalyst in catalytic converters. It is also used to catalyze industrial processes. | \nRhodium is used as an alloying agent for hardening and improving the corrosion resistance of platinum and palladium. | \nAs a result of its low electrical resistance, low and stable contact resistance, and its stability against corrosion rhodium is used as an electrical contact material. | \nThe metal is used in jewelry and for decorations.",
    "dangers": "Rhodium is considered to be non-toxic. Some of its compounds are highly toxic and carcinogenic.",
    "name_origin": "The name is derived from the Greek 'rhodon', meaning rose coloured.",
  ...
  },
  {
    ...
    "discoverer": "William Hyde Wollaston",
    "discovery_year": 1803,
    "appearance": "Palladium is a rare, lustrous, silvery-white metal.",
    "place": "Palladium occurs in nature as a free metal and also alloyed with gold, platinum, and other platinum group metals. Commercially, it is produced from nickel–copper ore deposits where it is found in small quantities.",
    "uses": "The largest use of palladium is in catalytic converters for automobiles. | \nFinely divided palladium is used as a catalyst for hydrogenation/dehydrogenation reactions and for petroleum cracking. | \nThe metal is used in jewelry, for example in white gold (an alloy of gold decolorized by the addition of palladium). | \nPalladium is used in dentistry, watch making, and in making surgical instruments and electrical contacts. | \nIt is also used to purify hydrogen because the gas easily diffuses through heated palladium.",
    "dangers": "Palladium is considered to be of low toxicity.",
    "name_origin": "Palladium is named after the asteroid Pallas, in turn named after the Greek goddess of wisdom, Pallas.",
  ...
  },
  {
    ...
    "discovery_year": 1817,
    "appearance": "Cadmium is a soft, malleable, ductile, bluish-white metal, which is easily cut with a knife",
    "place": "Cadmium most often occurs in small quantities associated with zinc ores, such as sphalerite (ZnS). Greenockite (CdS) is the only cadmium mineral of any consequence. Almost all cadmium is obtained as a by-product of zinc, copper, and lead ore refining operations.",
    "uses": "Cadmium’s major use is in batteries (especially rechargeable nickel–cadmium, NiCad, batteries).",
    "dangers": "Cadmium and its compounds are highly toxic.",
    "name_origin": "The name is derived from the Latin 'cadmia', the name for the mineral calmine.",
  ...
  },
  {
    ...
    "discovery_year": 1863,
    "appearance": "Indium is a very soft, silvery-white lustrous metal.",
    "place": "Indium has no minerals or ores with a high concentration of the element. Commercially, indium is extracted as a by-product of zinc refining. It is also extracted from iron, lead, and copper ores.",
    "uses": "Indium is used in the production of low-melting alloys, typically with gallium. | Compounds of indium are used in the semiconductor industry for germanium transistors, thermistors, rectifiers and photocells. | Indium-tin oxide thin films are used for liquid crystal displays (LCDs).",
    "dangers": "Indium is considered to be of low toxicity.",
    "name_origin": "The name comes from the Latin 'indicium', meaning violet or indigo.",
  ...
  },
  {
    ...
    "discoverer": "Unknown",
    "discovery_year": "Ancient",
    "appearance": "Tin is a silvery-white, soft, malleable metal that can be highly polished.",
    "place": "Tin very rarely occurs free in nature. The chief ore is cassiterite (SnO2). The metal is prepared from cassiterite by reducing the ore with coal.",
    "uses": "Tin is used as a coating on the surface of other metals to prevent corrosion.",
    "dangers": "Tin is considered to be non-toxic but most tin salts are toxic. The inorganic salts are caustic but of low toxicity. Organometallic compounds of tin are highly toxic.",
    "name_origin": "The name comes from the Anglo-Saxon 'tin'",
  ...
  },
  {
    ...
    "discoverer": "Unknown",
    "discovery_year": "Ancient",
    "appearance": "Antimony is metalloid, so it has some metallic properties but not enough to be classified as a true metal. Physically, it behaves like sulfur while chemically it is more metallic.",
    "place": "Most antimony is produced from stibnite (antimony sulfide, Sb2S3). It is also extracted as a byproduct of copper, gold and silver production.",
    "uses": "The major use of antimony is in lead alloys – mainly for use in batteries – adding hardness and smoothness of finish. | Antimony is used in the semiconductor industry as an n-type dopant for silicon. | Antimony trioxide is used as a flame retardant in adhesives, plastics, rubber and textiles.",
    "dangers": "Like arsenic, which sits directly above it in the periodic table, the toxicity of antimony and its compounds varies according to the chemical state of the element. Many of the salts are carcinogenic.\nThe metallic form is considered to be less active whereas stibine (SbH3) and stibnite (Sb2S3) are extremely toxic. Antimony is toxic and immediately dangerous to life or health at 50 mg m-3 or above. \nExposure to 9 milligrams per cubic meter of air (mg/m3) of antimony as stibnite for a long time can irritate your eyes, skin, and lungs. Breathing 2 mg/m3 of antimony for a long time can cause problems with the lungs (pneumoconiosis) heart problems (altered electrocardiograms), stomach pain, diarrhea, vomiting and stomach ulcers. People who drank over 19 ppm of antimony in one sitting vomited.",
    "name_origin": "The name derives from the Greek 'anti - monos', meaning not alone",
  ...
  },
  {
    ...
    "discovery_year": 1798,
    "appearance": "Tellurium is a rare, silvery-white, brittle, lustrous metalloid.",
    "place": "Tellurium is sometimes found free in nature. More commonly, it is found combined with metals, such as in the minerals calaverite (gold telluride, AuTe2) and sylvanite (silver-gold telluride). Commercially, tellurium is obtained as a byproduct of electrolytic copper refining.",
    "uses": "Tellurium is alloyed with copper and stainless steel to make these metals more workable. | Tellurium is used as a coloring agent in ceramics. | Tellurium is also used in the electronics industry, for example with cadmium and mercury to form photosensitive semiconductors. Cadmium telluride (CdTe) is used as a thin film in solar panels to convert sunlight into electricity. CdTe panels have an efficiency rating of between 11 and 13 percent compared to amorphous silicon solar panels which have an efficiency of between 7 to 9 percent. | It is used in vulcanizing rubber and in catalysts for petroleum cracking and in blasting caps for explosives.",
    "dangers": "Tellurium is very toxic and teratogenic (can cause harm to developing embryos). Exposure to as little as 0.01 mg/m2 or less in air leads to “tellurium breath”, which has a garlic-like odor.",
    "name_origin": "The name is derived from the Latin 'tellus', meaning Earth.",
  ...
  },
  {
    ...
    "discovery_year": 1811,
    "appearance": "Iodine is a bluish-black, lustrous solid.",
    "place": "In nature, iodine occurs in the form of iodide ions, mainly in seawater. It is introduced into the food chain via seaweed and other sea-plants. Iodine is found in some minerals and soils.\n\nCommercially, iodine is obtained in several ways, such as taking iodine vapor from processed brine, by ion exchange of brine or by releasing iodine from iodate taken from nitrate ores.",
    "uses": "Iodine is important in medicine, in both radioactive and non-radioactive forms. Iodide and thyroxin, which contains iodine, are used inside the body. | Silver iodide is used in photography. | Iodine is sometimes added to table salt to prevent thyroid disease. |\nIodine’s other uses include catalysts, animal feeds and printing inks and dyes.",
    "dangers": "In small doses, iodine is slightly toxic and it is highly poisonous in large amounts. Elemental iodine is an irritant which can cause sores on the skin. Iodine vapor causes extreme eye irritation.",
    "name_origin": "The name is derived from the Greek 'iodes' meaning violet.",
  ...
  },
  {
    ...
    "discoverer": "William Ramsay | Morris Travers.",
    "discovery_year": 1898,
    "appearance": "Xenon is a rare, colorless, odorless heavy gas.",
    "place": "Xenon is a trace gas in Earth’s atmosphere. It is obtained commercially by fractional distillation of liquid air.",
    "uses": "Xenon is used in photographic flashes, in high pressure arc lamps for motion picture projection, and in high pressure arc lamps to produce ultraviolet light. | \nIt is used in instruments for radiation detection, e.g., neutron and X-ray counters and bubble chambers. | \nXenon is used in medicine as a general anesthetic and in medical imaging. | \nModern ion thrusters for space travel use inert gases – especially xenon – for propellant, so there is no risk of the explosions associated with chemical propulsion.",
    "dangers": "Xenon is not considered to be toxic but many of its compounds are toxic as a result of their strong oxidizing properties",
    "name_origin": "The name is derived from the Greek 'xenos' meaning stranger.",
  ...
  },
  {
    ...
    "discoverer": "Robert Bunsen | Gustav Kirchhoff",
    "discovery_year": 1860,
    "appearance": "Cesium is silvery-gold, soft, ductile alkali metal.",
    "place": "Cesium is found in the minerals pollucite and lepidolite. Commercially, most cesium is produced as a byproduct of the production of lithium metal. More than two-thirds of the world’s reserves of Cesium – 110,000 tonnes – are found at Bernic Lake, Manitoba, Canada.",
    "uses": "Cesium is used in atomic clocks, which are incredibly accurate. | Cesium is also used in photoelectric cells and as a catalyst in the hydrogenation of organic compounds. The metal is used as a ‘getter’ in vacuum tubes.",
    "dangers": "Cesium must be kept under an inert liquid/gas or in a vacuum to protect it from air and water. Cesium compounds are considered to be mildly toxic.",
    "name_origin": "The name comes from the Latin 'caesius', meaning sky blue, and derived from its flame colour.",
  ...
  },
  {
    ...
    "discoverer": "Carl Wilhelm Scheele",
    "discovery_year": 1808,
    "appearance": "Barium is a metallic element chemically resembling calcium but more reactive. It is a soft, silvery metal and when cut it quickly turns a black color due to the formation of barium oxide, (BaO).",
    "place": "Commercially obtained from the electrolysis of molten Barium Chloride, BaCl2",
    "uses": "Barium is used as a “flashed getter” in vacuum tubes to remove the last traces of gases. | An alloy of barium with nickel is used in sparkplug wire. | Barium sulfate (barite) is used to increase the contrast in x-ray imaging of the digestive system.",
    "dangers": "Barium compounds that are water or acid soluble are highly poisonous. Barium powder can ignite spontaneously in air. | \nBarium sulfate, used in x-ray imaging, is highly insoluble in water, and is therefore nontoxic and completely removed from the digestive tract.",
    "name_origin": "The name comes from the Greek 'barys', meaning heavy.",
  ...
  },
  {
    ...
    "discovery_year": 1839,
    "appearance": "Lanthanum is a silvery-white soft metal, which can be cut with a knife.",
    "place": "Lanthanum is not found free in nature. It is found mainly in the minerals monazite and bastnaesite. Commercially, it is recovered from monazite sand and bastnaesite using various complex extraction techniques. Pure lanthanum is obtained by the reduction of the fluoride with calcium metal.",
    "uses": "Lanthanum is used in large quantities in nickel metal hydride (NiMH) rechargeable batteries for hybrid automobiles. | Lanthanum is used as a petroleum cracking catalyst, catalyzing the splitting of long chain hydrocarbons into shorter chained species. | Lanthanum is used as an additive to make nodular cast iron and as an additive in steel. | Lanthanum is used in hydrogen sponge alloys, which take up to 400 times their own volume of hydrogen gas. | Lanthanum is also used to make night vision goggles (infrared-absorbing glass). | High quality camera and telescope lenses contain lanthanum oxide (La2O3) making use of its high refractive index and low dispersion. | Lanthanum carbonate is used to reduce blood levels of phosphate in patients with kidney disease. | Lanthanum compounds are also used in some pool products to reduce the level of phosphate nutrients that algae feed on.",
    "dangers": "Lanthanum and its compounds are considered to be moderately toxic.",
    "name_origin": "The name is derived from the Greek 'lanthanein', meaning to lie hidden.",
  ...
  },
  {
    ...
    "name": "Cerium",
    "symbol": "Ce",
    "discoverer": "Jacob Berzelius | Wilhelm von Hisinger | Martin Klaproth",
    "discovery_year": 1803,
    "appearance": "Cerium is a reactive, soft, gray, lustrous metal that is malleable and ductile.",
    "place": "Cerium is the most abundant of the lanthanides. It is not found free in nature but is found in a number of minerals, mainly allanite, bastnasite and monazite. Commercially, cerium is prepared by electrolysis of the chloride or by reduction of the fused fluoride with calcium.",
    "uses": "Cerium is used in carbon-arc lighting, especially in the motion picture industry. It is also used in phosphors for color television screens and fluorescent lighting. | Cerium oxide is used as a catalytic converter to reduce carbon monoxide emissions in the exhaust fumes from automobiles.",
    "dangers": "Cerium is considered to be moderately toxic.",
    "name_origin": "Cerium is named for the asteroid, Ceres, which in turn was named after the Roman God of agriculture.",
  ...
  },
  {
    ...
    "discovery_year": 1885,
    "appearance": "Praseodymium is a soft, malleable, ductile, silvery metal.",
    "place": "Praseodymium is not found free in nature but is found in a number of minerals mainly monazite and bastnaesite. It is recovered commercially by ion exchange techniques and counter-current liquid-liquid extraction processes from monazite sand and bastnaesite. Praseodymium metal can be prepared by reduction of the anhydrous chloride.",
    "uses": "Praseodymium is used in high-intensity permanent magnets, which are essential in electric motors and generators used in hybrid cars and wind turbines. | Praseodymium is used to make specialized yellow glass goggles for glass blowers and welders. | Praseodymium salts are used to color glasses and enamels. | Praseodymium is also used in the core of high-intensity carbon arc lights used by the film industry and in floodlighting.",
    "dangers": "Praseodymium is considered to be moderately toxic.",
    "name_origin": "The name is derived from the Greek 'prasios didymos' meaning green twin.",
  ...
  },
  {
    ...
    "discoverer": "Carl Auer von Welsbach.",
    "discovery_year": 1885,
    "appearance": "Neodymium is a soft, bright, silvery white metal.",
    "place": "Neodymium is not found free in nature but is found in a number of minerals – mainly monazite and bastnaesite. Commercially it is extracted from monazite and bastnaesite by ion exchange and solvent extraction processes. Neodymium metal can be made by the reduction of anhydrous halides with calcium metal.",
    "uses": "Neodymium is used with iron and boron to create powerful permanent magnets, also called NIB magnets. | Neodymium is used as a crystal (neodymium-doped yttrium aluminum garnet) in lasers. | Neodymium is used to make specialized goggles for glass blowers. | Neodymium salts are used to color glasses and enamels.",
    "dangers": "Neodymium is considered to be moderately toxic.",
    "name_origin": "The name is derived from the Greek 'neos didymos' meaning new twin.",
  ...
  },
  {
    ...
    "place": "Promethium’s longest-lived isotope has a half-life of only 18 years. For this reason it is not found naturally on Earth. It has been found that a star in the Andromeda galaxy is manufacturing promethium, but it is not known how.\n\nPromethium can be produced by irradiating neodymium and praseodymium with neutrons, deuterons and alpha particles. It can also be prepared by ion exchange of nuclear reactor fuel processing wastes.",
    ...
    "dangers": "Promethium has no known biological role.",
    "name_origin": "Promethium is named after Prometheus of Greek mythology who stole fire from the Gods and gave it to humans.",
  ...
  },
  {
    ...
    "dangers": "Samarium has no known biological role. It has low toxicity.",
    "name_origin": "The name is derived from samarskite, the name of the mineral from which it was first isolated.",
  ...
  },
  {
    ...
    "place": "In common with other lanthanides, europium is mainly found in the minerals monazite and bastnaesite. It can be prepared from these minerals. However, the usual method of preparation is by heating europium(Ill) oxide with an excess of lanthanum under vacuum.",
    ...
    "dangers": "Europium has no known biological role. It has low toxicity.",
    "name_origin": "Europium is named after Europe",
  ...
  },
  {
    ...
    "place": "In common with other lanthanides, gadolinium is mainly found in the minerals monazite and bastnaesite. It can be commercially prepared from these minerals by ion exchange and solvent extraction. It is also prepared by reducing anhydrous gadolinium fluoride with calcium metal.",
    ...
    "dangers": "Gadolinium has no known biological role, and has low toxicity.",
    "name_origin": "Gadolinium was named in honour of Johan Gadolin.",
  ...
  },
  {
    ...
    "dangers": "Terbium has no known biological role. It has low toxicity.",
    "name_origin": "Terbium was named after Ytterby, Sweden.",
  ...
  },
  {
    ...
    "place": "In common with many other lanthanides, dysprosium is found in the minerals monazite and bastnaesite. It is also found in smaller quantities in several other minerals such as xenotime and fergusonite.\n\nIt can be extracted from these minerals by ion exchange and solvent extraction. It can also be prepared by the reduction of dysprosium trifluoride with calcium metal.",
    ...
    "dangers": "Dysprosium has no known biological role. It has low toxicity.",
    "name_origin": "The name is derived from the Greek 'dysprositos', meaning hard to get.",
  ...
  },
  {
    ...
    "name": "Holmium",
    "symbol": "Ho",
    "discoverer": "Per Teodor Cleve at Uppsala, Sweden and independently by Marc Delafontaine and Louis Soret in Geneva, Switzerland",
    "discovery_year": 1878,
    "appearance": "A bright, silvery metal.",
    "place": "Holmium is found as a minor component of the minerals monazite and bastnaesite. It is extracted from those ores that are processed to extract yttrium. It is obtained by ion exchange and solvent extraction.",
    ...
    "dangers": "Holmium has no known biological role, and is non-toxic.",
    "name_origin": "The name is derived from the Latin name for Stockholm, 'Holmia'.",
  ...
  },
  {
    ...
    "place": "Erbium is found principally in the minerals monazite and bastnaesite. It can be extracted by ion exchange and solvent extraction",
    ...
    "dangers": "Erbium has no known biological role, and has low toxicity.",
    "name_origin": "Erbium is named after Ytterby, Sweden,",
  ...
  },
  {
    ...
    "discovery_year": 1879,
    "appearance": "A bright, silvery metal.",
    "place": "Thulium is found principally in the mineral monazite, which contains about 20 parts per million. It is extracted by ion exchange and solvent extraction. The metal is obtained by reducing the anhydrous fluoride with calcium, or reducing the oxide with lanthanum.",
    ...
    "dangers": "Thulium has no known biological role. It is non-toxic.",
    "name_origin": "The name comes from Thule, the ancient name for Scandinavia.",
  ...
  },
  {
    ...
    "place": "In common with many lanthanide elements, ytterbium is found principally in the mineral monazite. It can be extracted by ion exchange and solvent extraction.",
    ...
    "dangers": "Ytterbium has no known biological role. It has low toxicity.",
    "name_origin": "Ytterbium is named after Ytterby, Sweden.",
  ...
  },
  {
    ...
    "name": "Lutetium",
    "symbol": "Lu",
    "discoverer": "Georges Urbain in Paris, France and independently by Charles James in New Hampshire, USA",
    "discovery_year": 1907,
    "appearance": "A silvery-white, hard, dense metal.",
    "place": "In common with many other lanthanides, the main source of lutetium is the mineral monazite. It is extracted, with difficulty, by reducing the anhydrous fluoride with calcium metal.",
    ...
    "dangers": "Lutetium has no known biological role. It has low toxicity.",
    "name_origin": "The name derives from the Romans' name for Paris, 'Lutetia'.",
  ...
  },
  {
    ...
    "name": "Hafnium",
    "symbol": "Hf",
    "discoverer": "George Charles de Hevesy and Dirk Coster",
    "discovery_year": 1923,
    "appearance": "A shiny, silvery metal that resists corrosion and can be drawn into wires.",
    "place": "Most zirconium ores contain around 5% hafnium. The metal can be prepared by reducing hafnium tetrachloride with sodium or magnesium.",
    ...
    "dangers": "Hafnium has no known biological role, and it has low toxicity.",
    "name_origin": "The name is derived from the Latin name for Copenhagen, 'Hafnia'",
  ...
  },
  {
    ...
    "dangers": "Tantalum has no known biological role. It is non-toxic.",
    "name_origin": "The name is derived from the legendary Greek figure King Tantalus.",
    "history": "Tantalum was reported as a new metal in 1802 by Anders Gustav Ekeberg at Uppsala University, Sweden. However, when William Wollaston analysed the minerals from which it had been extracted he declared it was identical to niobium which has been discovered the year previously. It was as a result of their similarity that there was confusion regarding their identification. These two elements often occur together and, being chemically very similar, were difficult to separate by the methods available at the time of the discovery.\n\nIt was not until 1846 that Heinrich Rose separated tantalum and niobium and proved conclusively that they were different elements, and yet his sample of tantalum was still somewhat impure, and it was not until 1903 that pure tantalum was produced by Werner von Bolton."
  },
  {
    "atomic_number": 74,
    "name": "Tungsten",
    "symbol": "W",
    "discoverer": "Juan and Fausto Elhuyar",
    "discovery_year": 1783,
    "appearance": "A shiny, silvery-white metal.",
    "place": "The principal tungsten-containing ores are scheelite and wolframite. The metal is obtained commercially by reducing tungsten oxide with hydrogen or carbon.",
    ...
    "dangers": "Tungsten is the heaviest metal to have a known biological role. Some bacteria use tungsten in an enzyme to reduce carboxylic acids to aldehydes.",
    "name_origin": "The name is derived from the Swedish 'tung sten' meaning heavy stone.",
  ...
  },
  {
    ...
    "place": "Osmium occurs uncombined in nature and also in the mineral osmiridium (an alloy with iridium). Most osmium is obtained commercially from the wastes of nickel refining.",
    ...
    "dangers": "Osmium has no known biological role. The metal is not toxic, but its oxide is volatile and very toxic, causing lung, skin and eye damage.",
    "name_origin": "The name is derived from the Greek word 'osme', meaning smell.",
  ...
  },
  {
    ...
    "dangers": "Iridium has no known biological role, and has low toxicity.",
    "name_origin": "The name is derived from the Greek goddess of the rainbow, Iris.",
  ...
  },
  {
    ...
    "symbol": "Pt",
    "discoverer": "Unknown",
    "discovery_year": "Known to native South Americans before Columbus, and taken to Europe around 1750",
    "appearance": "A shiny, silvery-white metal as resistant to corrosion as gold.",
    "place": "Platinum is found uncombined in alluvial deposits. Most commercially produced platinum comes from South Africa, from the mineral cooperite (platinum sulfide). Some platinum is prepared as a by-product of copper and nickel refining.",
    ...
    "dangers": "Platinum has no known biological role. It is non-toxic.",
    "name_origin": "The name is derived from the Spanish 'platina', meaning little silver.",
  ...
  },
  {
    ...
    "place": "Gold is one of the few elements to occur in a natural state. It is found in veins and alluvial deposits. About 1500 tonnes of gold are mined each year. About two-thirds of this comes from South Africa and most of the rest from Russia.\n\nSeawater contains about 4 grams of gold in 1,000,000 tonnes of water. Overall this is a huge amount of gold stored in the oceans but, because the concentration is so low, attempts to reclaim this gold have always failed.",
    ...
    "dangers": "Gold has no known biological role, and is non-toxic.",
    "name_origin": "The name is the Anglo-Saxon word for the metal and the symbol comes from the Latin ‘aurum’, gold.",
  ...
  },
  {
    ...
    "symbol": "Hg",
    "discoverer": "Unknown",
    "discovery_year": "1500BC",
    "appearance": "A liquid, silvery metal.",
    "place": "Mercury rarely occurs uncombined in nature, but can be found as droplets in cinnabar (mercury sulfide) ores. China and Kyrgyzstan are the main producers of mercury. The metal is obtained by heating cinnabar in a current of air and condensing the vapour.",
  ...
  },
  {
    ...
    "place": "Thallium is found in several ores. One of these is pyrites, which is used to produce sulfuric acid. Some thallium is obtained from pyrites, but it is mainly obtained as a by-product of copper, zinc and lead refining.\n\nThallium is also present in manganese nodules found on the ocean floor.",
    ...
    "dangers": "Thallium has no known biological role. It is very toxic and there is evidence that the vapour is both teratogenic (disturbs the development of an embryo or foetus) and carcinogenic. It can displace potassium around the body affecting the central nervous system.",
    "name_origin": "Thallium is derived from the Greek 'thallos', meaning a green twig.",
  ...
  },
  {
    ...
    "place": "Lead is chiefly obtained from the mineral galena by a roasting process. At least 40% of lead in the UK is recycled from secondary sources such as scrap batteries and pipes.",
    ...
    "dangers": "Lead has no known biological role. It can accumulate in the body and cause serious health problems. It is toxic, teratogenic (disturbs the development of an embryo or foetus) and carcinogenic.\n\nDaily intake of lead from all sources is about 0.1 milligrams. The average human body stores about 120 milligrams of lead in the bones.",
    "name_origin": "The name comes from the Anglo-Saxon word for the metal, 'lead'",
  ...
  },
  {
    ...
    "place": "Bismuth occurs as the native metal, and in ores such as bismuthinite and bismite. The major commercial source of bismuth is as a by-product of refining lead, copper, tin, silver and gold ores.",
    ...
    "dangers": "Bismuth has no known biological role, and is non-toxic.",
    "name_origin": "The name come from the German 'Bisemutum' a corruption of 'Weisse Masse' meaning white mass.",
  ...
  },
  {
    ...
    "place": "Polonium is a very rare natural element. It is found in uranium ores but it is uneconomical to extract it. It is obtained by bombarding bismuth-209 with neutrons to give bismuth-210, which then decays to form polonium. All the commercially produced polonium in the world is made in Russia.",
    ...
    "dangers": "Polonium has no known biological role. It is highly toxic due to its radioactivity.",
    "name_origin": "Polonium is named after Poland, the native country of Marie Curie, who first isolated the element.",
  ...
  },
  {
    ...
    "place": "Astatine can be obtained in a variety of ways, but not in weighable amounts. Astatine-211 is made in nuclear reactors by the neutron bombardment of bismuth-200.",
    ...
    "dangers": "Astatine has no known biological role. It is toxic due to its radioactivity.",
    "name_origin": "The name comes from the Greek 'astatos', meaning unstable.",
  ...
  },
  {
    ...
    "place": "Radon is produced naturally from the decay of the isotope radium-226, which is found in rocks. It was first discovered as a radioactive gas produced from radium as it decayed. There is a detectable amount in the Earth’s atmosphere.",
    ...
    "dangers": "Radon has no known biological role. It is, however, thought that it may have had a significant role in evolution. This is because it is responsible for much of the Earth’s background radiation that can lead to genetic modifications.",
    "name_origin": "The name is derived from radium, as it was first detected as an emission from radium during radioactive decay.",
  ...
  },
  {
    ...
    "place": "Francium is obtained by the neutron bombardment of radium in a nuclear reactor. It can also be made by bombarding thorium with protons.",
    "uses": "Francium has no uses, having a half life of only 22 minutes.",
    "dangers": "Francium has no known biological role. It is toxic due to its radioactivity.",
    "name_origin": "Francium is named after France.",
  ...
  },
  {
    ...
    "place": "Radium is present in all uranium ores, and could be extracted as a by-product of uranium refining. Uranium ores from DR Congo and Canada are richest in radium. Today radium is extracted from spent fuel rods from nuclear reactors. Annual production of this element is fewer than 100 grams per year.",
    ...
    "dangers": "Radium has no known biological role. It is toxic due to its radioactivity.",
    "name_origin": "The name is derived from the Latin 'radius', meaning ray.",
  ...
  },
  {
    ...
    "name": "Actinium",
    "symbol": "Ac",
    "discoverer": "André Debierne at Paris",
    "discovery_year": 1899,
    ...
    "place": "Actinium used for research purposes is made by the neutron bombardment of radium-226. Actinium also occurs naturally in uranium ores.",
    "uses": "Actinium is a very powerful source of alpha rays, but is rarely used outside research.",
    "dangers": "Actinium has no known biological role. It is toxic due to its radioactivity.",
    "name_origin": "The name is derived from the Greek 'actinos', meaning a ray.",
  ...
  },
  {
    ...
    "place": "Thorium is found as the minerals thorite, uranothorite and thorianite. It is also found in monazite, which is the most important commercial source. Several methods are used to produce the metal, such as reducing thorium oxide with calcium or electrolysis of the fluoride.",
    ...
    "dangers": "Thorium has no known biological role. It is toxic due to its radioactivity.",
    "name_origin": "Thorium is named after Thor, the Scandinavian god of war",
  ...
  },
  {
    ...
    "name": "Protactinium",
    "symbol": "Pa",
    "discoverer": "Kasimir Fajans | Otto Göhring",
    "discovery_year": 1913,
    "appearance": "A silvery, radioactive metal.",
    "place": "Small amounts of protactinium are found naturally in uranium ores. It is also found in spent fuel rods from nuclear reactors, from which it is extracted.",
    "uses": "Protactinium is little used outside of research.",
    "dangers": "Protactinium has no known biological role. It is toxic due to its radioactivity.",
    "name_origin": "The name is derived from the Greek 'protos', meaning first, as a prefix to the element actinium, which is produced through the radioactive decay of proactinium.",
  ...
  },
  {
    ...
    "place": "Uranium occurs naturally in several minerals such as uranite (pitchblende), brannerite and carnotite. It is also found in phosphate rock and monazite sands. World production of uranium is about 41,000 tonnes per year.",
    "uses": 0,
    "dangers": "It is a toxic metal",
    "name_origin": "Uranium was named after the planet Uranus.",
  ...
  },
  {
    ...
    "discovery_year": 1940,
    "appearance": "A radioactive metal.",
    "place": "Neptunium is obtained as a by-product from nuclear reactors. It is extracted from the spent uranium fuel rods. Trace quantities occur naturally in uranium ores.",
    "uses": "Neptunium is little used outside research. The isotope neptunium-237 has been used in neutron detectors.",
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Neptunium was named after the planet Neptune.",
  ...
  },
  {
    ...
    "discovery_year": 1940,
    "appearance": "A radioactive, silvery metal.",
    "place": "The greatest source of plutonium is the irradiation of uranium in nuclear reactors. This produces the isotope plutonium-239, which has a half-life of 24,400 years.",
    ...
    "dangers": "It is extremely toxic due to its radioactivity.",
    "name_origin": "Plutonium, is named after the then planet Pluto, following from the two previous elements uranium and neptunium.",
  ...
  },
  {
    ...
    "place": "Americium occurs naturally in uranium minerals, but only in trace amounts. The main source of the element is the neutron bombardment of plutonium in nuclear reactors. A few grams are produced in this way each year.",
    ...
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Americium is named for America where it was first made.",
  ...
  },
  {
    ...
    "place": "Curium can be made in very small amounts by the neutron bombardment of plutonium in a nuclear reactor. Minute amounts may exist in natural deposits of uranium. Only a few grams are produced each year.",
    "uses": "Curium has been used to provide power to electrical equipment used on space missions.",
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Curium is named in honour of Pierre and Marie Curie.",
  ...
  },
  {
    ...
    "name": "Berkelium",
    "symbol": "Bk",
    "discoverer": "Stanley Thompson | Albert Ghiorso | Glenn Seaborg",
    "discovery_year": 1949,
    "appearance": "Berkelium is a radioactive, silvery metal.",
    "place": "Less than a gram of berkelium is made each year. It is made in nuclear reactors by the neutron bombardment of plutonium-239.",
    "uses": "Because it is so rare, berkelium has no commercial or technological use at present.",
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Berkelium was named after the town Berkeley, California, where it was first made.",
  ...
  },
  {
    ...
    "name": "Californium",
    "symbol": "Cf",
    "discoverer": "Stanley Thompson | Kenneth Street, Jr. | Albert Ghiorso | Glenn Seaborg",
    "discovery_year": 1950,
    "appearance": "Californium is a radioactive metal.",
    "place": "Californium did not exist in weighable amounts until ten years after its discovery. It is prepared, in milligram amounts only, by the neutron bombardment of plutonium-239.",
    ...
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Californium is named for the university and state of California, where the element was first made.",
  ...
  },
  {
    ...
    "place": "Einsteinium can be obtained in milligram quantities from the neutron bombardment of plutonium in a nuclear reactor.",
    "uses": "Einsteinium has no uses outside research.",
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Einsteinium is named after the renowned physicist Albert Einstein.",
  ...
  },
  {
    ...
    "place": "Fermium can be obtained, in microgram quantities, from the neutron bombardment of plutonium in a nuclear reactor.",
    "uses": "Fermium has no uses outside research.",
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Fermium is named after the nuclear physicist Enrico Fermi.",
  ...
  },
  {
    ...
    "place": "Mendelevium does not occur naturally. It is made by bombarding einsteinium with alpha particles (helium ions).",
    "uses": "Mendelevium is used only for research.",
    "dangers": "",
    "name_origin": "Mendelevium is named for Dmitri Mendeleev who produced one of the first periodic tables.",
  ...
  },
  {
    ...
    "name": "Nobelium",
    "symbol": "No",
    "discoverer": "Georgy Flerov and colleagues | Albert Ghiorso and colleagues",
    "discovery_year": 1963,
    "appearance": "Nobelium is a radioactive metal. Only a few atoms have ever been made. Its half-life is only 58 minutes.",
    "place": "Nobelium is made by bombarding curium with carbon in a device called a cyclotron.",
    "uses": "Nobelium has no uses outside research.",
    "dangers": "It is toxic due to its radioactivity.",
    "name_origin": "Nobelium is named for Alfred Nobel, the founder of the Nobel prize.",
  ...
  },
  {
    ...
    "discovery_year": 1965,
    "appearance": "A radioactive metal of which only a few atoms have ever been created.",
    "place": "Lawrencium does not occur naturally. It is produced by bombarding californium with boron",
    "uses": "Lawrencium has no uses outside research.",
    "dangers": "",
    "name_origin": "Lawrencium is named after Ernest O. Lawrence the inventor of the cyclotron.",
  ...
  },
  {
    ...
    "place": "Rutherfordium is a transuranium element. It is created by bombarding californium-249 with carbon-12 nuclei.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Rutherfordium is named in honour of New Zealand Chemist Ernest Rutherford, one of the first to explain the structure of atoms.",
  ...
  },
  {
    ...
    "name": "Dubnium",
    "symbol": "Db",
    "discoverer": "Scientists at both Berkeley, California, USA, and Dubna, near Moscow, Russia",
    "discovery_year": "1968-1970",
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Dubnium does not occur naturally. It is a transuranium element created by bombarding californium-249 with nitrogen-15 nuclei.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Dubnium is named for the Russian town Dubna.",
  ...
  },
  {
    ...
    "place": "Seaborgium is a transuranium element. It is created by bombarding californium-249 with oxygen-18 nuclei.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Seaborgium is named for Glenn T. Seaborg, who was instrumental in producing several transuranium elements.",
  ...
  },
  {
    ...
    "name": "Bohrium",
    "symbol": "Bh",
    "discoverer": "Peter Armbruster | Gottfried Münzenberg",
    "discovery_year": 1981,
    "appearance": "Bohrium is a highly radioactive metal.",
    "place": "Bohrium does not occur naturally and only a few atoms have ever been made. It will probably never be isolated in observable quantities. It was created by the so-called ‘cold fusion’ method. This involved the bombardment of bismuth with atoms of chromium.",
    "uses": "At present, bohrium is of research interest only.",
    "dangers": "",
    "name_origin": "Bohrium is named for the Danish atomic physicist Niels Bohr",
  ...
  },
  {
    ...
    "discovery_year": 1984,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Hassium does not occur naturally and it will probably never be isolated in observable quantities. It is created by bombarding lead with iron atoms",
    "uses": "At present it is only used in research.",
    "dangers": "",
    "name_origin": "The name is derived from the German state of Hesse where Hassium was first made.",
  ...
  },
  {
    ...
    "discovery_year": 1982,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Fewer than 10 atoms of meitnerium have ever been made, and it will probably never be isolated in observable quantities. It is made by bombarding bismuth with iron atoms.",
    "uses": "At present it is only used in research.",
    "dangers": "",
    "name_origin": "Meitnerium is named for the Austrian physicist Lise Meitner.",
  ...
  },
  {
    ...
    "name": "Darmstadtium",
    "symbol": "Ds",
    "discoverer": "Sigurd Hofmann | Peter Armbruster | Gottfried Münzenberg",
    "discovery_year": 1994,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "A man-made element of which only a few atoms have ever been created. It that is formed by fusing nickel and lead atoms in a heavy ion accelerator.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Darmstadtium is named after Darmstadt, Germany, where the element was first produced.",
  ...
  },
  {
    ...
    "discovery_year": 1994,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "A man-made element of which only a few atoms have ever been created. It is made by fusing nickel and bismuth atoms in a heavy ion accelerator.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "The name roentgenium (Rg) was proposed by the GSI team in honour of the German physicist Wilhelm Conrad Röntgen, and was accepted as a permanent name on November 1, 2004",
  ...
  },
  {
    ...
    "name": "Copernicium",
    "symbol": "Cn",
    "discoverer": "Sigurd Hofmann and colleagues",
    "discovery_year": 1996,
    ...
    "place": "Copernicium is a man-made element of which only a few atoms have ever been made. It is formed by fusing lead and zinc atoms in a heavy ion accelerator.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Copernicium is named for the Renaissance scientist Nicolaus Copernicus",
  ...
  },
  {
    ...
    "name": "Nihonium",
    "symbol": "Nh",
    "discoverer": "Scientists from RIKEN (The Institute of Physical and Chemical Research) in Japan",
    "discovery_year": 2004,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Unknown",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "The name refers to the Japanese name for Japan.",
  ...
  },
  {
    ...
    "name": "Flerovium",
    "symbol": "Fl",
    "discoverer": "Scientists from the Joint Institute for Nuclear Research in Dubna, Russia and the Lawrence Livermore National Laboratory, California, USA.",
    "discovery_year": 1999,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Flerovium can be formed in nuclear reactors.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Named after the Russian physicist Georgy Flerov who founded the Joint Institute for Nuclear Research where the element was discovered.",
  ...
  },
  {
    ...
    "name": "Moscovium",
    "symbol": "Mc",
    "discoverer": "Scientists from the Joint Institute for Nuclear Research in Dubna, Russia, the Lawrence Livermore National Laboratory in California, USA, and Oak Ridge National Laboratory in Tennessee, USA",
    "discovery_year": 2010,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Unknown",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "The name refers to the Moscow region, where the Joint Institute of Nuclear Research is based.",
  ...
  },
  {
    ...
    "discovery_year": 2000,
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Livermorium does not occur naturally. It is made by bombarding curium atoms with calcium. The most stable isotope has a half-life of about 53 milliseconds.",
    "uses": "At present, it is only used in research.",
    "dangers": "",
    "name_origin": "Named after the Lawrence Livermore National Laboratory.",
  ...
  },
  {
    ...
    "appearance": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "place": "Unknown",
    "uses": "A highly radioactive metal, of which only a few atoms have ever been made.",
    "dangers": "",
    "name_origin": "The name refers to the US state of Tennessee.",
    "history": "IUPAC confirmed the discovery (by scientists from the Joint Institute for Nuclear Research in Dubna, Russia, the Lawrence Livermore National Laboratory in California, USA, and Oak Ridge National Laboratory in Tennessee, USA) in 2015. This entry will be updated when more information is available."
  }
]